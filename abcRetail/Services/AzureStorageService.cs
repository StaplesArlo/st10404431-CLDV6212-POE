...
namespace abcRetail.Services
{
    public class AzureStorageService : IAzureStorageService
    {
        ...
        {
            // This uses the type name to decide which table to target.
            // Adjust mappings if your table names differ from entity class names.
            var type = typeof(T);
            ...
            return type.Name switch
            {
                ...
                _ => throw new InvalidOperationException(
                         $"No table mapping defined for type {type.Name}")
            };
        }
    }
}